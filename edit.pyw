...
class TextEditor:
  def __init__(self,root):
    self.root = root
    self.root.title("Shivay 1.02 EDIT")
    self.root.geometry("1200x700+200+150")
    self.filename = None
    self.title = StringVar()
    self.status = StringVar()
    self.titlebar = Label(self.root,textvariable=self.title,font=("times new roman",15),bd=2,relief=GROOVE)
    ...
    self.txtarea = Text(self.root,yscrollcommand=scrol_y.set,font=("times new roman",15),state="normal",relief=GROOVE)
